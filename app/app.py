...
from app.authentication.app import app as auth_app
from app.music.app import app as music_app
from app.services.websocket_channel import WebsocketChannel
from app.settings import ENV, settings
from app.youtube.app import app as youtube_app
